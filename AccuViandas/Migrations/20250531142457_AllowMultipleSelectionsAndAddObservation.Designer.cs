...
namespace AccuViandas.Migrations
{
    ...
    [Migration("20250531142457_AllowMultipleSelectionsAndAddObservation")]
    partial class AllowMultipleSelectionsAndAddObservation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccuViandas.Models.UserMenuSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTime>("SelectionDateTime")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AccuViandas.Models.UserMenuSelection", b =>
                {
                    ...
                    b.HasOne("AccuViandas.Models.User", "User")
                        .WithMany("UserMenuSelections")
            ...
            modelBuilder.Entity("AccuViandas.Models.User", b =>
                {
                    b.Navigation("UserMenuSelections");
                });
